...
export default {
  name: "차11 C안 — 통합", width: W, height: H, fps: 30,
  theme: { preset: "chartmyeongga" }, market,
  scenes: [{
    id: "C", name: "통합", duration: 0.5,
    ...
    layers: [
      ...
      { type: "hline", price: LV.boxHi, color: "#7A7A7A", width: 8, dash: [26, 18], growDur: 0 },
      { type: "hline", price: LV.boxLo, color: "#7A7A7A", width: 8, dash: [26, 18], growDur: 0 },
