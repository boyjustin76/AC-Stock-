  ...
  scenes: [
      ...
      layers: [
        {
          ...
          size: 46,
          color: '#F38808',
          /*  손그림 원(봉37)이 '상방'을 반으로 갈라 안 읽혔다 (2026-09-03 확인).
              원 10 위, 버튼 20 아래인 15 로 올려 선이 글자 뒤로 지나가게 한다.  */
          z: 15,
          in: [0.5, 0.35],
          out: [3.3, 0.4],
        },
    ...
    /* ── ⑤ CTA — 20일선이 옆으로 누우면? (36.83~43.40) ──────────── */
    {
      ...
      layers: [
        ...
        {
          /*  마무리 카드의 스크림만 먼저 깐다. 박스권 원은 이 위에 오고(안 그러면
              0.85 스크림에 먹혀 사라진다), 글자는 다시 그 원 위에 온다 — 한 장의
              titleCard 로는 스크림과 글자 사이에 원을 끼울 수 없어 둘로 나눴다.
              두 장이 같은 in 을 쓰므로 등장 알파는 예전과 똑같다.  */
          type: 'titleCard',
          title: '',
          scrimStrength: 0.85,
          rule: false,
        ...
        },
        {
          ...
          color: '#FFFFFF',
          scrim: false,
          /*  원(10)이 '누우면?'의 획을 뚫고 지나가 있었다. 15 로 올려 원이 글자
              뒤로 지나가게 한다 — 강조 원의 본래 모양이다.  */
          z: 15,
          in: [1.9, 0.45],
        },
      ],
