  ...
  scenes: [
    ...
    /* ── 컷17 1분 차트 — 크로스가 아니라 배열 (15.2333s) ── */
    {
      ...
      layers: [
        ...
        { type: 'cmgBadge', text: '1분 차트', x: 96, y: 300, size: 42, color: COLOR.badge, border: false, in: [2.2, 0.3] },
        { type: 'cmgBadge', text: '10일선', x: 96, y: 374, size: 40, color: COLOR.ma10, border: false, in: [4.6, 0.3] },
        { type: 'cmgBadge', text: '34일선', x: 96, y: 446, size: 40, color: COLOR.ma34, border: false, in: [5.6, 0.3] },
       ...
       가격 앵커 요소는 국면 0/1 복제를 같은 창에서 크로스페이드. */
    {
      ...
      chart: {
        ...chartStill,
        include: [LV.stop - 4],
        phases: [{ reveal: 224, in: [8.0, 0.5] }],
      },
      layers: [
        rsiChip(),
        { type: 'cmgBadge', text: '1분 차트', x: 96, y: 300, size: 42, color: COLOR.badge, border: false, popDur: 0, out: [4.9, 0.4] },
        /* 국면0 — 진입 직후 화면의 손익 구조 */
        { type: 'cmgArrow', bar: 200, price: LV.entry, dir: 'buy', label: '매수', size: 34, gap: 16, popDur: 0, out: [8.0, 0.5] },
        { type: 'cmgLevel', price: LV.entry, fromBar: 198, color: 'rgba(0,0,0,0.72)', thickness: 4, growDur: 0.35, in: [0.6, 0.2], out: [8.0, 0.5] },
        { type: 'cmgLevel', price: LV.stop, fromBar: 198, fillTo: LV.entry, fill: COLOR.slFill, color: COLOR.sl, label: '손절', labelSize: 36, thickness: 11, growDur: 0.4, in: [1.0, 0.2], out: [8.0, 0.5] },
        { type: 'cmgLevel', price: LV.target, fromBar: 198, fillTo: LV.entry, fill: COLOR.tpFill, color: COLOR.tp, label: '익절', labelSize: 36, thickness: 11, growDur: 0.4, in: [3.2, 0.2], out: [8.0, 0.5] },
        { type: 'cmgBadge', text: '손익비  1 : 2', x: 96, y: 300, size: 44, color: COLOR.badge, border: false, in: [5.1, 0.3] },
        { type: 'cmgArrow', bar: 207, price: 29457.5, dir: 'sell', label: '익절 1/2', color: '#0DA82A', size: 32, gap: 16, popDur: IN.pop, in: [6.2, 0.2], out: [8.0, 0.5] },
        /* 국면1 — 진행된 스틸 위에 같은 구조를 이어받고 러너 수익 */
        { type: 'cmgArrow', phase: 1, bar: 200, price: LV.entry, dir: 'buy', label: '매수', size: 30, gap: 14, popDur: 0, in: [8.0, 0.5] },
        { type: 'cmgLevel', phase: 1, price: LV.entry, fromBar: 198, color: 'rgba(0,0,0,0.72)', thickness: 4, growDur: 0, in: [8.0, 0.5] },
        { type: 'cmgArrow', phase: 1, bar: 207, price: 29457.5, dir: 'sell', label: '익절 1/2', color: '#0DA82A', size: 28, gap: 14, popDur: 0, in: [8.0, 0.5] },
