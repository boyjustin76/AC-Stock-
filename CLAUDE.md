...
영상 한 편은 네 단계다. **이 저장소는 롱폼 3단계 하나만 한다.**

| 포맷 | 1. 대본 만들기 | 1.5 성우 녹음 | 2. 컷편집·자막 | 3. 모션그래픽·소스 |
|---|---|---|---|---|
| **롱폼** | 사람 (결과물 인덱스만 보유) | 외부 | 사람 · 프리미어 | **← 이 저장소** |
| **숏폼** | 미착수 | 외부 | 미착수 | 미착수 (톤앤매너 미조사) |

- **받는 것**: 타임코드가 붙은 대본 (2단계 산출물)
- **내놓는 것**: 차트만 있는 영상 클립. 프리미어에 얹는 것은 사람이 한다
- 1·2 단계를 대신 하지 않는다. 대본을 쓰거나 컷을 자르지 않는다
- 숏폼(9:16)은 아직 범위 밖이다. 시작하려면 최종본 숏츠 실측이 먼저다
