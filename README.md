...
| 시각 (KST) | 슬롯 | 커밋 | 어디까지 |
|---|---|---|---|
| 2026-09-18 16:44 | `save/2026-09-18-1644` | `4efb4f5` | MT5 자체 렌더 캡처 — ChartScreenShot 지표와 shot.py (새 차트+템플릿, 사람 차트 안 건드림) |
| 2026-09-18 16:39 | `save/2026-09-18-1639` | `55f2cb3` | MT5 차트 화면 가져오기 도구 — MCP 클라이언트·창 캡처·봉격자/가격축 자동보정 (RMS 1.93px) |
| 2026-09-18 15:46 | `save/2026-09-18-1546` | `0be66ea` | MT5 MCP 연동 시험 — 도구 50종 확인, 창 캡처로 차트 배경, 틀·배지·로고 얹어 3초 렌더 |
| 2026-09-18 15:37 | `save/2026-09-18-1537` | `8b8328a` | A/B 시험 — ov-pnl 컷을 우리 렌더러와 HyperFrames 로 각각 렌더해 속도·줄수·픽셀 대조 |
| 2026-09-18 14:55 | `save/2026-09-18-1455` | `bff748f` | HyperFrames·Remotion 실측 — 59.94 유리수 fps·ProRes4444 알파·PNG 시퀀스 확인, 색 정확도 차이 기록 |
| 2026-09-18 14:40 | `save/2026-09-18-1440` | `2a7eddd` | 경로 끝 공백·마침표 — tools/style 6개의 사람이 치는 --out 을 만들 때 떼어 낸다 (B·E 실측 + D 재현) |
