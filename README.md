...
| 2026-08-28 23:37 | `save/2026-08-28-2337` | `d8490d6` | SL 차11-4·11-5 주말 편집 — STT 컷편집(무음 보정)·자막·1:1 차트 소스 렌더·납품(드라이브+전달), tools/cutedit 신설 |
| 2026-08-28 18:32 | `save/2026-08-28-1832` | `df240d5` | README 생성기 — 포인트 규칙을 SL 표에서 분리(별도 갈래 문단) |
