...
| **숏폼** | 9:16 | 1080x1920 / 30fps (최종본 260703 실측) | 미정 (모션그래픽 단계 미착수) | 50~85초 (25편 실측 중앙값 66초) | 대본은 조사됨 — 훅·근거·본론·CTA 4단, 초당 6.6자, 한 편이 롱폼의 9%. 화면 톤앤매너는 아직 미조사 |
...
롱폼 한 편 (약 4,000자)
   ...
   └─ 350~560자로 다시 쓴다     ← 롱폼 전체의 9% 안팎, 약 53~85초

        ① 훅    오늘은 …를 알려드릴게요        20~55자
        ② 근거  통념 → 하지만 → 손실          110~290자
        ③ 본론  기준·설정값·순서를 숫자로       150~370자
        ④ CTA   답 없이 질문으로 넘김          40~135자
                → 이 질문이 다음 편의 주제가 된다
```
...
| 시각 (KST) | 슬롯 | 커밋 | 어디까지 |
|---|---|---|---|
| 2026-08-27 11:37 | `save/2026-08-27-1137` | `0174bd8` | 숏폼 대본 추출 규칙 역설계 — 25편 분석, 규칙 17개, 도구, 초안 2편 |
