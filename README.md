...
| 시각 (KST) | 슬롯 | 커밋 | 어디까지 |
|---|---|---|---|
| 2026-08-27 17:56 | `save/2026-08-27-1756` | `72f79d5` | 파일 지도 정리 — tools/photoshop 항목이 넓은 tools 키에 먹히던 것 |
| 2026-08-27 17:53 | `save/2026-08-27-1753` | `966df8f` | 썸네일 도구 고정 — tools/photoshop(JSX+드라이버) 추가, 채택안 A·C 를 deliver/ 에 |
| 2026-08-27 17:38 | `save/2026-08-27-1738` | `83bd01a` | 차11 썸네일 A·C 확정 — 포토샵 COM 편집, 버튼을 브랜드 실측 비율+에스코어드림5로 |
| 2026-08-27 15:56 | `save/2026-08-27-1556` | `e7707db` | 썸네일을 로컬 클로드에게 넘김 — 이 컨테이너는 롱폼 3단계·숏폼 1단계만 |
| 2026-08-27 15:46 | `save/2026-08-27-1546` | `c808bcc` | 썸네일 PNG 납품 — 템플릿 버튼 원본 픽셀 사용, .psd 접음 |
| 2026-08-27 15:13 | `save/2026-08-27-1513` | `47bab78` | 썸네일 PSD 포토샵 열기 오류 수정 (EngineData run 짝) + 타이틀 래스터 굽기 |
