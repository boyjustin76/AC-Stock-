...
| 시각 (KST) | 슬롯 | 커밋 | 어디까지 |
|---|---|---|---|
| 2026-08-31 22:14 | `save/2026-08-31-2214` | `683e6f0` | 차12 v3 재납품 — 미리보기 피드백 4건 반영 (가시성·우측 여백·상단 잘림·가속), probe-labels 도구 신설 |
| 2026-08-31 18:28 | `save/2026-08-31-1828` | `1c409a2` | 차12 v2 — 정확.srt 재동기 26컷 재렌더·재납품, 배치표 v2·xml·zip4, 자막 진본 constraint |
| 2026-08-31 16:07 | `save/2026-08-31-1607` | `daa1b35` | 차12 시퀀스 XML 납품 — FCP XML 경로 사용자 검증 완료, 갭 배치 22 clipitem |
| 2026-08-31 13:41 | `save/2026-08-31-1341` | `1c3301c` | 하단 여백 135px + FCP XML 시퀀스 납품 — tools/premiere_xml.py 신설, sl-11-4 v9·11-5 v7 |
| 2026-08-31 11:32 | `save/2026-08-31-1132` | `ce8b652` | 숏폼 세이프 에어리어 실측 반영 — sl-11-4 v8·11-5 v6 재렌더·재납품(1301/1382 검증), FX pool·constraint·요청48 |
| 2026-08-31 10:25 | `save/2026-08-31-1025` | `d8fa648` | zip 한글 엔트리 실패 → SL 11-4 v7·11-5 v5 영문명 재패키징(재렌더·내레이션 재컷 검증), 차12 1of4·4of4 재빌드, constraint·요청47 기록 |
