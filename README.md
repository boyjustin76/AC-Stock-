...
| 시각 (KST) | 슬롯 | 커밋 | 어디까지 |
|---|---|---|---|
| 2026-09-16 16:28 | `save/2026-09-16-1628` | `12e246e` | 롤링 광고 모서리 문양 - 새로 그린 3안 반려, 차트명가 로고 심볼을 핑크 반투명으로 키워 쓰는 방식으로 교체 |
| 2026-09-16 16:18 | `save/2026-09-16-1618` | `a1c448a` | 롤링 광고 - CTA 화살표가 금테에 걸리는 것 고침 · 모서리 문양을 차트명가 로고에서 뽑은 3안(막대계단·처마·원)으로 교체, 처마 채택 |
