...
/** 경로 한 조각 끝의 공백·마침표를 뗀다 — **constraint_note 56**.
    ...
    2026-09-21 일러스트레이터로도 재서 파이썬과 같음을 확인했다(56 의 '추정' 줄을 지웠다) —
    부모 폴더 끝 공백이면 saveAs 가 "the operation was cancelled" 로 실패한다. 폴더가 없다는
    말이 아니라서 원인을 찾기 어렵다. 끝 마침표는 네 경우 모두 통과한다(이름만 달라진다). */
