...
/* ── 구역 (1920x1080 화면 좌표, y 는 위에서 아래) ─────────────────
   ...
   더원트레이더 틀(`더원트레이더_라이브화면_틀.png`, 1672x941)을 재서 비율로 옮겼다:

     칸        더원 y(941)   비율      우리 y(1080)
     시계       77~171      .082~.182   140~218   (그대로 — 우리 광고 띠가 더 두껍다)
     포지션    177~299      .188~.318   247~397   (헤더 띠 221~247 포함)
     수익요약  305~434      .324~.461   403~519
     댓글      440~731      .468~.777   526~849
     캠        740~925      .786~.983   856~1063  ← 비워 둔다

   캠 자리 위쪽(.786)이 기준점이다. 포지션표·댓글창 캡쳐는 늘리지 않고 **잘라서**(capCrop)
   줄인 칸에 맞춘다 — 포지션표는 아래쪽이 흰 여백이라 잘려 나가는 것이 없다. */
var Z = {
    ...
    포지션: { x:1521, y:247,  w:399,  h:150 },
    메모:   { x:1521, y:403,  w:399,  h:116 },
    댓글:   { x:1521, y:526,  w:399,  h:323 },
    캠:     { x:1521, y:856,  w:399,  h:207 }    // 비워 둔다 — OBS 에서 캠이 올라온다
};
