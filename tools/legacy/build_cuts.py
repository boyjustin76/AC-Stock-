# -*- coding: utf-8 -*-
"""레거시 (2026-09-17 격리 — 실행 금지). 차11-4·5 때 쓴 1세대 컷편집 스크립트.

지금 쓰는 도구는 tools/cutedit/cut_and_srt.py 다 (그 안의 build_cuts() 함수가 이 파일과
이름이 같아 헷갈려서 옮겼다 — E 회신 2026-09-16 §1-2). 09-01 이후 쓴 적이 없다.
폴더 안 cam.mp4 전제, 회차 전용 WORD_FIXES, imageio-ffmpeg 임포트가 남아 있다.

원래 머리말: aligned.json → 컷리스트 + 편별 내레이션(wav/mp3) + 참고영상(mp4) + 자막(srt).
