...
REQUESTS = [
    ...
    (66, "r12 확인 — 완벽. 정리해 두고, B·E·(D) 가 커밋 푸시해 둔 것들이 잘 병합됐는지 확인하고 너도 정리하라 "
     "(압축 예정).",
...
NEXT_STEPS = [
    ...
    (27, "AE 실전 — 차12 인트로 레이어 컴포지션 (파일럿 성공 후속)", "이정찬 보고(2026-09-01): D 가 m1~m6 "
     ...
     "필요해지면 총괄이 확장. → A0~A6 병합·판정 완료(2026-09-03, request 66): .mogrt 채택 — 프리미어 "
     "[속성] 한글 컨트롤 9개, 표현식 생존. 남은 것은 차12 실전 컴포지션(next_step 28)과 양산기"
     "(scenes.js→jsx 변환) 논의",
