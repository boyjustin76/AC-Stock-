...
NEXT_STEPS = [
    ...
    (47, "팀장 반려 문장 쌍 수동 수집 — E", "반려·첨삭이 올 때마다 고치기 전/후 문장 쌍을 tools/theone/ 에 jsonl 로. 회차·날짜·누가 고쳤나(팀장/전문가/편집) 표시. 30쌍 넘으면 decision 35 다시 본다. 첫 자료가 이미 있다(09-21): 차12 6차 ↔ 이정찬판 INTRO~3구간(팀장 피드백을 이정찬이 적용) — 이 diff 에서 쌍을 뽑으면 된다", "반려가 올 때마다 · 첫 쌍 추출은 E 가 시간 날 때"),
