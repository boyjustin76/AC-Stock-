...
NEXT_STEPS = [
    ...
    (28, "차12 롱폼 잔여 — D 레이어 분해 후속만", "차12 조립은 r9 에서 확정 (2026-09-02 이정찬: '12r9 확인했고 "
     "완벽'). v2→r9 아홉 라운드의 피드백·해결은 request 52~62 와 룰북 ⑤~⑯이 전부다. 남은 것은 D 의 AE "
     "레이어 분해(클립 경계 소멸 — 재등장 계열 근본 해소)가 오면 차12 소스를 레이어 컴포지션으로 재납품할지 "
     "결정하는 것뿐",
     "D 작업 후"),
    (29, "차12 브리지 톤앤매너 교체 — 차명10 카드 문법으로", "이정찬 스샷 실측(2026-09-02): 차명10 개념 카드는 "
     ...
     "→ r10(request 63) 반려 후 r11(request 64)로 확정: 핑크 박스 제목 전용·민짜, 그림자는 텍스트만 "
     "(prproj 블롭 실측 프리셋). 남은 것은 이정찬의 r11 확인뿐",
     "완료 — r11 납품, 이정찬 확인 대기"),
