...
REPO_FILES = {
    ...
    "log/inbox/2026-09-21_D_Jev시험.md": ("기록", "D — Jev 시험: D-3 오류 분류 11/12(상위 2~3 제안), D-2 분류 기준에 따라 6/9↔9/9, D-1 생존 편향으로 미실시(줄 단위 제안), scenes.py 규칙 2 절반만 맞음"),
...
NEXT_STEPS = [
    ...
    (51, "Jev 시험 — B (자료 준비됨 09-21. '해당 없음' 선택지·허용 목록 승인 — 돌려도 된다)", "B-1 모달 문구 → 처리 종류 Choice(실제 문구 5~6개 전부) · B-2 썸네일 강조 대상 Choice(규칙 22, 빨강 든 회차 전부) · B-3 오류 분류(20건 중 16). 픽셀·색 코드·캡처 판정은 제외", "B (자리 바꿔 두 번, confidence 같이)"),
