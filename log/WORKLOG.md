...
14. **썸네일 PSD 는 보류** — 두 번 고쳐 보냈는데 포토샵이 계속 거부했다. PNG 로 납품하는 쪽으로 돌렸다. .psd 가 다시 필요해지면 원인부터 다시 잡아야 한다 — 지금 tools/psdedit.py 는 EngineData 짝과 lyid 중복은 잡지만 그것만으로는 부족했다  _(대기: 사용자 판단)_
