...
| 177 | `f699cb42` | prproj_titles.py — 소제목·챕터 범퍼 전수 실측, §14 재작성 | 2파일 +332/-42 |
| 178 | `48a75e5a` | 범퍼는 구조로 잡는다 — 커지기 짝 밑 텍스트, 차명11 기준으로 차명12 문구 재작성 | 2파일 +119/-82 |
| 179 | `41acd1f6` | 세이브 save/2026-09-01-1832 — r7 — guide-rsi ①방향 유지·fail-combo 겹침 해소(폭 판정 보충), 요청 58, 룰북 ⑩보충2 | 7파일 +34/-6 |
| 180 | `79a124be` | 세이브 기록 save/2026-09-01-1832 | 5파일 +11/-3 |
| 181 | `ae6bfc2c` | 세이브 save/2026-09-01-1917 — 말 구간 브리지 2클립(cmgText·blurPx·종이+버튼) + 팀장 어휘 실측 카탈로그(룰북 §E), 요청 59 — 렌더 진행 중 | 10파일 +272/-4 |
| 182 | `fa647233` | 세이브 기록 save/2026-09-01-1917 | 5파일 +14/-4 |
| 183 | `8be5faad` | 보고서 §15 도구 목록 · §16 결정 대기 — Fable 인계용 정리 | 1파일 +57/-1 |
| 184 | `49e0ec42` | 세이브 save/2026-09-02-1130 — 세이프 에어리어(룰북 ⑮, padTop216/padBottom162 전 씬) + z확장(동그라미·배지, ⑭) + recap 폰트 통일(⑯) + 브리지 버튼 정렬 — 요청 60, r8 렌더 중 | 15파일 +87/-38 |
| 185 | `76d3a156` | 세이브 기록 save/2026-09-02-1130 | 5파일 +11/-3 |
| 186 | `ed6cc823` | 세이브 save/2026-09-02-1152 — rightGap 5→0 전 씬(⑥ 보충 — 차트 오른쪽 끝까지) + 우측 끝 라벨 2건 보정 — r8 재렌더 중 | 12파일 +19/-13 |
| 187 | `21811a92` | 세이브 기록 save/2026-09-02-1152 | 5파일 +11/-3 |
| 188 | `87d91eb6` | 세이브 save/2026-09-02-1420 — 이월 요소 재등장 효과 제거 — layers.js isStill/enter(등장 창 32곳), 룰북 ⑧ 보충, 요청 61 — r9 렌더 중 | 6파일 +67/-33 |
| 189 | `80487b28` | 세이브 기록 save/2026-09-02-1420 | 5파일 +11/-3 |
| 190 | `5663048b` | 세이브 save/2026-09-02-1847 — 마감 정리 — r9 확정 기록, 요청 62, next_step 28·29 재편(D 후속·브리지 톤앤매너) | 5파일 +27/-17 |
| 191 | `adbdbb28` | 세이브 기록 save/2026-09-02-1847 | 5파일 +11/-3 |
| 192 | `adb6bc4e` | 세이브 save/2026-09-02-1903 — 브리지 r10 차명10 재스타일 — 렌더러(밴드·그림자·fill)+경기천년바탕+룰북 §E-2+DB, 렌더 진행 중 | 9파일 +147/-51 |
| 193 | `f740e442` | 세이브 기록 save/2026-09-02-1903 | 5파일 +11/-3 |
| 194 | `b70c2bd2` | 세이브 save/2026-09-02-2034 — 브리지 r10 납품 + 블러 80분 원인 수정 (오프스크린 1장 블러, 23배) | 5파일 +40/-7 |
| 195 | `9757739f` | 세이브 기록 save/2026-09-02-2034 | 5파일 +11/-3 |
| 196 | `c47ae309` | 세이브 save/2026-09-03-0052 — 브리지 r11 납품 — 박스 제목 전용·그림자는 텍스트만 (차명10 prproj 프리셋 직접 실측) + 텍스트 그림자 스크래치 블러 | 7파일 +137/-60 |
| 197 | `2ba27ccc` | 세이브 기록 save/2026-09-03-0052 | 5파일 +11/-3 |
| 198 | `38e2f357` | 세이브 save/2026-09-03-0932 — 브리지 r12 납품 — 기울임꼴 + 그림자 우하단 (r11 반려 2건 반영) | 7파일 +32/-11 |
| 199 | `78f24f4c` | 세이브 기록 save/2026-09-03-0932 | 5파일 +11/-3 |
| 200 | `730cd4d3` | 세이브 save/2026-09-03-1012 — 격자박스 도입 — 썸네일 좌상단 타이틀을 상자에 맞춰 17% 축소, 차12 6안 재빌드 (규칙 28·29, 요청 59) | 14파일 +167/-17 |
| 201 | `f8d32585` | 세이브 기록 save/2026-09-03-1012 | 5파일 +11/-3 |
| 202 | `c8c674bf` | 병합 — 원격 브리지 r7~r12 + 로컬 썸네일 격자박스 | 22파일 +820/-136 |
| 203 | `8af3613b` | Merge remote-tracking branch 'origin/local/script-lab' into claude/futures-youtube-video-edit-fhio4s | 8파일 +1214/-43 |
| 204 | `26bf1a1d` | Merge remote-tracking branch 'origin/local/ae-lab' into claude/futures-youtube-video-edit-fhio4s | 31파일 +2178/-0 |
...
| 209 | `1ef29130` | 세이브 기록 save/2026-09-03-1218 | 5파일 +11/-3 |
| 210 | `57a5d988` | 세이브 save/2026-09-03-1258 — D 검토 답변 — AE 글자 3~5px, 길 A 채택(함정 3 포함) · 세로 기준 전환 부결 — 요청 69 | 4파일 +25/-5 |
